...
<div class="wrapper">
    ...
    <div class="maincontainer">
        <div class="subnav">
            <ul>
                <li><a href="displayyesschoolcourse.action?currPage=1">院系必修课</a></li>
        ...
        <div class="tablecontainer">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>
                    	<s:if test='#d.timestart=="a" '>星期一  第1-2节 1-16周</s:if>
...
<script type="text/javascript">
	...
	function prepage(){
		if( ${currPage}==1){
			...
			window.location.href="displaypubliccourse.action?currPage="+(parseInt(${currPage},10)-1);
		}
	}
	function nextpage(){
