...
<div class="wrapper">
    ...
    <div class="maincontainer">
        <div class="subnav">
            <ul>
                <li><a href="#" class="navactive">主修课程</a></li>
                <li><a href="#">辅修课程</a></li>
            </ul>
        ...
        <div class="tablecontainer">
            ...
            <table class="table table-striped">
                ...
                <s:iterator value="#session.selectedra" var="d" status="st">
                <s:if test='#d.checked=="lost"'>
                <tbody>
                <tr>
                    <th>2016-2017学年 第一学期</th>
                    <th><s:property value="#d.courseid"/></th>
                    <th><s:property value="#session.selected[#st.index].coursename"/></th>
                    <th><s:property value="#session.selected[#st.index].credit"/></th>
                    <th><s:property value="#session.selected[#st.index].coursetype"/></th>
                    <th><s:property value="#session.selected[#st.index].courseidentity"/></th>
                </tr>
                </tbody>
                </s:if> 
                </s:iterator>
