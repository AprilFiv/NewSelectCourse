    ...
    <div class="maincontainer">
        <div class="subnav">
            <ul>
                ...
                <li><a href="#" class="navactive">全校性必修课</a></li>
...
<script type="text/javascript">
	function jump(){
		...
		if (page>totalpage){
			...
			window.location.href="displayyesschoolcourse.action?currPage="+page;
		}
	}
	function homepage(){
		if( ${currPage}==1){
			...
			window.location.href="displayyesschoolcourse.action?currPage=1";
		}
	}
	function prepage(){
		if( ${currPage}==1){
			...
			window.location.href="displayyesschoolcourse.action?currPage="+(parseInt(${currPage},10)-1);
		}
	}
	function nextpage(){
	...
	function lastpage(){
		if( ${currPage}==${totalPage}){
			...
			window.location.href="displayyesschoolcourse.action?currPage="+${totalPage};
		}
	}
</script>
<script type="text/javascript">
