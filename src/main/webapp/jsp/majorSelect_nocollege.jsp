     ...
     <input type="hidden" value="<%=whetheredit%>" id="whetheredit"/>
        <div class="subnav">
            <ul>
                ...
                <li><a href="#" class="navactive">院系选修课</a></li>
                <li><a href="displaynoschoolcourse.action?currPage=1">全校性选修课</a></li>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td><s:if test='#d.timestart=="a" '>星期一  第1-2节 1-16周</s:if>
                    	...
                    	<s:if test='#d.timestart=="k" '>星期二  第9-10节 1-16周</s:if>
                    </td>
...
<script type="text/javascript">
	function jump(){
		...
		if (page>totalpage){
			...
			window.location.href="displaynocollegecourse.action?currPage="+page;
		}
	}
	function homepage(){
		if( ${currPage}==1){
			...
			window.location.href="displaynocollegecourse.action?currPage=1";
		}
	}
	function prepage(){
		if( ${currPage}==1){
			...
			window.location.href="displaynocollegecourse.action?currPage="+(parseInt(${currPage},10)-1);
		}
	}
	function nextpage(){
	...
	function lastpage(){
		if( ${currPage}==${totalPage}){
			...
			window.location.href="displaynocollegecourse.action?currPage="+${totalPage};
		}
	}
</script>
<script type="text/javascript">
