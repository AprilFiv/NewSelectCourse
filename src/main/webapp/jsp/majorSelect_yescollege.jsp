...
<div class="wrapper">
    ...
    <div class="maincontainer">
        <div class="subnav">
            <ul>
                <li><a href="#" class="navactive">院系必修课</a></li>
...
<script type="text/javascript">
	function jump(){
		...
		if (page>totalpage){
			...
			window.location.href="displayyescollegecourse.action?currPage="+page;
		}
	}
	function homepage(){
		if( ${currPage}==1){
			...
			window.location.href="displayyescollegecourse.action?currPage=1";
		}
	}
	function prepage(){
		if( ${currPage}==1){
			...
			window.location.href="displayyescollegecourse.action?currPage="+(parseInt(${currPage},10)-1);
		}
	}
	function nextpage(){
	...
	function lastpage(){
		if( ${currPage}==${totalPage}){
			...
			window.location.href="displayyescollegecourse.action?currPage="+${totalPage};
		}
	}
</script>
<script type="text/javascript">
